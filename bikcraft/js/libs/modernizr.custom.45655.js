      ...
      function r(a) {
        ...
        return (
          s.shivCSS &&
            ...
            (c.hasCSS = !!l(
              a,
              'article,aside,dialog,figcaption,figure,footer,header,hgroup,main,nav,section{display:block}mark{background:#FF0;color:$cor-secundaria}template{display:none}',
            )),
          k || q(a, c),
          a
        );
